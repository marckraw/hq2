...
export const MessageActions: React.FC<MessageActionsProps> = ({
  ...
  const actions: MessageAction[] = [
    ...
    ...(showActions.feedback && onThumbsUp
      ...
      : []),
    ...(showActions.feedback && onThumbsDown
      ? [{ id: "thumbsDown", label: "Bad", icon: ThumbsDown, onClick: onThumbsDown }]
      : []),
...
/**
 * QuickActions - Floating action bar for quick interactions
 */
