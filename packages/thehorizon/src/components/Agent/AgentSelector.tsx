...
export const AgentSelector = ({ value, onValueChange, agents, disabled }: AgentSelectorProps) => {
          ...
          {selectedAgent ? (
            <div className="flex items-center gap-2 w-full">
              ...
              <div className="flex flex-col items-start gap-0.5 flex-1 min-w-0">
                <span className="font-medium text-sm text-foreground">{selectedAgent.name}</span>
          ...
          <CommandList>
            ...
            <CommandGroup>
              {agents.map((agent) => (
                ...
                >
                  <Check className={cn("mr-2 h-4 w-4", value === agent.type ? "opacity-100" : "opacity-0")} />
                  <div className="flex items-center gap-2 w-full">
