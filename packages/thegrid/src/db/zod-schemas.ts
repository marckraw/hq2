...
export const conversationSelectSchema = createSelectSchema(dbSchema.conversations);
export const conversationInsertSchema = createInsertSchema(dbSchema.conversations);
export const conversationUpdateSchema = createUpdateSchema(dbSchema.conversations);
...
export const pipelineStepSelectSchema = createSelectSchema(dbSchema.pipelineSteps);
export const pipelineStepInsertSchema = createInsertSchema(dbSchema.pipelineSteps);
export const pipelineStepUpdateSchema = createUpdateSchema(dbSchema.pipelineSteps);

// ===== AGENT EXECUTION SCHEMAS =====
export const agentExecutionSelectSchema = createSelectSchema(dbSchema.agentExecutions);
export const agentExecutionInsertSchema = createInsertSchema(dbSchema.agentExecutions);
export const agentExecutionUpdateSchema = createUpdateSchema(dbSchema.agentExecutions);

export const agentExecutionStepSelectSchema = createSelectSchema(dbSchema.agentExecutionSteps);
export const agentExecutionStepInsertSchema = createInsertSchema(dbSchema.agentExecutionSteps);
export const agentExecutionStepUpdateSchema = createUpdateSchema(dbSchema.agentExecutionSteps);
...
export const notificationSelectSchema = createSelectSchema(dbSchema.notifications);
export const notificationInsertSchema = createInsertSchema(dbSchema.notifications);
export const notificationUpdateSchema = createUpdateSchema(dbSchema.notifications);
...
export const storyblokComponentSelectSchema = createSelectSchema(dbSchema.storyblokComponents);
export const storyblokComponentInsertSchema = createInsertSchema(dbSchema.storyblokComponents);
export const storyblokComponentUpdateSchema = createUpdateSchema(dbSchema.storyblokComponents);
...
export type AgentExecutionSelect = InferSchema<typeof agentExecutionSelectSchema>;
export type AgentExecutionInsert = InferSchema<typeof agentExecutionInsertSchema>;
export type AgentExecutionUpdate = InferSchema<typeof agentExecutionUpdateSchema>;

export type AgentExecutionStepSelect = InferSchema<typeof agentExecutionStepSelectSchema>;
export type AgentExecutionStepInsert = InferSchema<typeof agentExecutionStepInsertSchema>;
export type AgentExecutionStepUpdate = InferSchema<typeof agentExecutionStepUpdateSchema>;

// ===== VALIDATION HELPERS =====

// These work perfectly and preserve types
export const validateConversationInsert = (data: unknown): ConversationInsert | null => {
...
export const validatePipelineInsert = (data: unknown): PipelineInsert | null => {
